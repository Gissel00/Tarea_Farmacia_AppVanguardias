...
const getMedicamentos = async(req, res) =>{
    ...
    const medicamentos = await Medicamento.find({}, 'nombre laboratorio img cantidad fechaVencimiento');
...
const crearMedicamento = async(req, res = response) =>{
    ...
    const {nombre,laboratorio,img,cantidad,fechaVencimiento } = req.body
...
const actualizarMedicamento = async (req, res = response) =>{
    ...
    try {
        ...
        //Actualizar
        const { nombre,laboratorio,img,cantidad,fechaVencimiento , ...campos} = req.body;
